...
/opt/conda/bin/conda create --name=uman_app python=3.6
/opt/conda/envs/uman_app/bin/pip install -r /vagrant/requirements.txt
/opt/conda/envs/uman_app/bin/pip install gunicorn
